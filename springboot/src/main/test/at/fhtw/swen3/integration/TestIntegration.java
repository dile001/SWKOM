...
public class TestIntegration {
    ...
    String testSubmitParcel(){
        ...
        Recipient dummyRecipient= new Recipient().country("Österreich").city("Wien").street("Längenfeldgasse").postalCode("1120").name("TEST");
    ...
    private String stripToString(String jsonString){
        ...
        String newString= jsonString.substring(15, jsonString.length()-2);
        return newString;
